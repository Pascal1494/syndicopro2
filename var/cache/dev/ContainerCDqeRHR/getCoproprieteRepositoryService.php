 ...
 */
class getCoproprieteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CoproprieteRepository' shared autowired service.
     *
     * @return \App\Repository\CoproprieteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CoproprieteRepository.php';

        return $container->privates['App\\Repository\\CoproprieteRepository'] = new \App\Repository\CoproprieteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
