 ...
 */
class getStockBadgeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\StockBadgeRepository' shared autowired service.
     *
     * @return \App\Repository\StockBadgeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'StockBadgeRepository.php';

        return $container->privates['App\\Repository\\StockBadgeRepository'] = new \App\Repository\StockBadgeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
