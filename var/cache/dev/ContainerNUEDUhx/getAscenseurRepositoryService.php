 ...
 */
class getAscenseurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AscenseurRepository' shared autowired service.
     *
     * @return \App\Repository\AscenseurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AscenseurRepository.php';

        return $container->privates['App\\Repository\\AscenseurRepository'] = new \App\Repository\AscenseurRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
