 ...
 */
class getCategorieDepenseRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CategorieDepenseRepository' shared autowired service.
     *
     * @return \App\Repository\CategorieDepenseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CategorieDepenseRepository.php';

        return $container->privates['App\\Repository\\CategorieDepenseRepository'] = new \App\Repository\CategorieDepenseRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
