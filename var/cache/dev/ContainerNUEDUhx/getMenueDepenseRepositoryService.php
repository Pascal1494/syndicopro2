 ...
 */
class getMenueDepenseRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MenueDepenseRepository' shared autowired service.
     *
     * @return \App\Repository\MenueDepenseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MenueDepenseRepository.php';

        return $container->privates['App\\Repository\\MenueDepenseRepository'] = new \App\Repository\MenueDepenseRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
