...
class getDocumentCrudControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'Admin'.\DIRECTORY_SEPARATOR.'DocumentCrudController.php';

        $instance = new \App\Controller\Admin\DocumentCrudController();

        if (isset($container->services['App\\Controller\\Admin\\DocumentCrudController'])) {
            return $container->services['App\\Controller\\Admin\\DocumentCrudController'];
        }

        $container->services['App\\Controller\\Admin\\DocumentCrudController'] = $instance;

        $instance->setContainer(($container->privates['.service_locator.WOU_dzL'] ?? $container->load('get_ServiceLocator_WOUDzLService'))->withContext('App\\Controller\\Admin\\DocumentCrudController', $container));
