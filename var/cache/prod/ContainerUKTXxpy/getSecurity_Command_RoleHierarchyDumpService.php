 ...
 */
class getSecurity_Command_RoleHierarchyDumpService extends App_KernelProdDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['security.command.role_hierarchy_dump'] = $instance = new \Symfony\Bundle\SecurityBundle\Command\SecurityRoleHierarchyDumpCommand(($container->privates['security.role_hierarchy'] ?? $container->load('getSecurity_RoleHierarchyService')));
